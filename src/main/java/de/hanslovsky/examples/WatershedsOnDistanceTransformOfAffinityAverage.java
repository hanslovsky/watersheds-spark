...
public class WatershedsOnDistanceTransformOfAffinityAverage
{
	...
	public static < T extends RealType< T > & NativeType< T > > JavaRDD< Tuple2< RandomAccessibleInterval< UnsignedLongType >, Long > > flood(
			...
			final T extension )
	{
		final RunWatershedsOnDistanceTransformOfAffinityAverage< T, UnsignedLongType > rw = new RunWatershedsOnDistanceTransformOfAffinityAverage<>( sc, processBySlice, dtWeight, extension, new UnsignedLongType() );
